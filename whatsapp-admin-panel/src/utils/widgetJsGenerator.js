/**
 * Genera el código JavaScript puro del widget (sin tags <script>)
 * Este código se sube a Firebase Storage como archivo .js
 * y se carga desde Tag Manager usando un loader
 */

export const generateWidgetJS = (configUrl, projectId = '') => {
  return `(function() {
  'use strict';
...
/**
 * Genera el snippet loader para Tag Manager (10-12 líneas)
 */
export const generateLoaderSnippet = (jsUrl) => {
  return `<script>
(function() {
